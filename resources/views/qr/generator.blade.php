                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative group">
                                ...
                                <div class="border-2 border-dashed border-gray-300 rounded-xl p-8 text-center transition-all duration-300 hover:border-primary-500 hover:bg-primary-50/50 group-hover:shadow-lg"
                                     :class="form.logo ? 'border-primary-500 bg-primary-50/30' : ''"
                                    ...
                                    <!-- Upload Text -->
                                    <div class="space-y-2">
                                        <h4 class="text-lg font-semibold text-gray-900">Upload Logo</h4>
                                    ...
                                    <!-- File Preview -->
                                    <div x-show="form.logo" class="mt-4 p-4 bg-white rounded-lg border border-primary-200">
