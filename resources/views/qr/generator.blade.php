...
<div class="min-h-screen bg-gray-50 py-8">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-8">
            <h1 class="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Generator QR Code</h1>
            <p class="text-lg text-gray-600">Buat QR Code dengan kustomisasi lengkap</p>
        </div>

        <!-- Main Content -->
        <div class="flex flex-col lg:flex-row gap-8 main-layout" x-data="qrGenerator()" x-init="init()">
            ...
            <div class="w-full lg:w-1/2 bg-white rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100 form-panel">
                <form @submit.prevent="generateQR">
                    <!-- QR Type Selection -->
                    <div class="mb-8">
                        <label class="block text-sm font-semibold text-gray-700 mb-4">Jenis QR Code</label>
                        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-3">
                            <button type="button" @click="form.type = 'text'; updateFormFields()"
                                    :class="form.type === 'text' ? 'bg-[#138c79] text-white border-[#138c79]' : 'bg-white text-gray-700 hover:bg-gray-50 border-gray-200'"
                                    class="p-3 rounded-xl text-sm font-medium transition-all duration-200 flex flex-col items-center space-y-2 border-2 hover:border-[#138c79]/30">
                            ...
                            <button type="button" @click="form.type = 'url'; updateFormFields()"
                                    :class="form.type === 'url' ? 'bg-[#138c79] text-white border-[#138c79]' : 'bg-white text-gray-700 hover:bg-gray-50 border-gray-200'"
                                    class="p-3 rounded-xl text-sm font-medium transition-all duration-200 flex flex-col items-center space-y-2 border-2 hover:border-[#138c79]/30">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button type="button" @click="form.type = 'sms'; updateFormFields()"
                                    :class="form.type === 'sms' ? 'bg-[#138c79] text-white border-[#138c79]' : 'bg-white text-gray-700 hover:bg-gray-50 border-gray-200'"
                                    class="p-3 rounded-xl text-sm font-medium transition-all duration-200 flex flex-col items-center space-y-2 border-2 hover:border-[#138c79]/30">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button type="button" @click="form.type = 'whatsapp'; updateFormFields()"
                                    :class="form.type === 'whatsapp' ? 'bg-[#138c79] text-white border-[#138c79]' : 'bg-white text-gray-700 hover:bg-gray-50 border-gray-200'"
                                    class="p-3 rounded-xl text-sm font-medium transition-all duration-200 flex flex-col items-center space-y-2 border-2 hover:border-[#138c79]/30">
                            ...
                            <button type="button" @click="form.type = 'phone'; updateFormFields()"
                                    :class="form.type === 'phone' ? 'bg-[#138c79] text-white border-[#138c79]' : 'bg-white text-gray-700 hover:bg-gray-50 border-gray-200'"
                                    class="p-3 rounded-xl text-sm font-medium transition-all duration-200 flex flex-col items-center space-y-2 border-2 hover:border-[#138c79]/30">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button type="button" @click="form.type = 'email'; updateFormFields()"
                                    :class="form.type === 'email' ? 'bg-[#138c79] text-white border-[#138c79]' : 'bg-white text-gray-700 hover:bg-gray-50 border-gray-200'"
                                    class="p-3 rounded-xl text-sm font-medium transition-all duration-200 flex flex-col items-center space-y-2 border-2 hover:border-[#138c79]/30">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button type="button" @click="form.type = 'location'; updateFormFields()"
                                    :class="form.type === 'location' ? 'bg-[#138c79] text-white border-[#138c79]' : 'bg-white text-gray-700 hover:bg-gray-50 border-gray-200'"
                                    class="p-3 rounded-xl text-sm font-medium transition-all duration-200 flex flex-col items-center space-y-2 border-2 hover:border-[#138c79]/30">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button type="button" @click="form.type = 'wifi'; updateFormFields()"
                                    :class="form.type === 'wifi' ? 'bg-[#138c79] text-white border-[#138c79]' : 'bg-white text-gray-700 hover:bg-gray-50 border-gray-200'"
                                    class="p-3 rounded-xl text-sm font-medium transition-all duration-200 flex flex-col items-center space-y-2 border-2 hover:border-[#138c79]/30">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button type="button" @click="form.type = 'vcard'; updateFormFields()"
                                    :class="form.type === 'vcard' ? 'bg-[#138c79] text-white border-[#138c79]' : 'bg-white text-gray-700 hover:bg-gray-50 border-gray-200'"
                                    class="p-3 rounded-xl text-sm font-medium transition-all duration-200 flex flex-col items-center space-y-2 border-2 hover:border-[#138c79]/30">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <!-- Right Panel - Preview (50% width, sticky) -->
            <div id="preview-section" class="w-full lg:w-1/2 bg-white rounded-2xl shadow-xl p-6 lg:p-8 border border-gray-100 lg:sticky lg:top-8 lg:self-start lg:max-h-[calc(100vh-4rem)] lg:overflow-y-auto preview-panel">
                <div class="flex items-center mb-6">
                    <div class="w-8 h-8 bg-[#138c79]/10 rounded-lg flex items-center justify-center mr-3">
                        <svg class="w-5 h-5 text-[#138c79]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
