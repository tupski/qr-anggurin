...
@section('content')
<div class="bg-gradient-to-br from-[#138c79]/10 to-teal-50 py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Hero Section -->
        <div class="text-center">
            <h1 class="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
                QR Code Generator & Scanner
                <span class="text-[#138c79]">Gratis</span>
            </h1>
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                <a href="{{ route('qr.generator') }}" class="bg-[#138c79] hover:bg-[#0f7a69] text-white font-semibold py-4 px-8 rounded-lg text-lg transition duration-200 shadow-lg hover:shadow-xl">
                    <svg class="w-6 h-6 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                    </svg>
                    Buat QR Code
                </a>
                <a href="{{ route('qr.scanner') }}" class="bg-white hover:bg-gray-50 text-[#138c79] font-semibold py-4 px-8 rounded-lg text-lg transition duration-200 shadow-lg hover:shadow-xl border-2 border-[#138c79]">
                    <svg class="w-6 h-6 inline-block mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-gray-50 rounded-lg p-6">
                <div class="w-12 h-12 bg-[#138c79]/10 rounded-lg flex items-center justify-center mb-4">
                    <svg class="w-6 h-6 text-[#138c79]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<div class="py-16 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="text-center">
                <div class="w-16 h-16 bg-[#138c79] rounded-full flex items-center justify-center mx-auto mb-4">
