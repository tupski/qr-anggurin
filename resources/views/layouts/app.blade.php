        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-16 lg:h-20">
                ...
                <div class="lg:hidden" x-data="{ mobileMenuOpen: false }">
                    ...
                    <div class="fixed inset-0 bg-gradient-to-br from-[#138c79] to-[#0f7a69] z-50 flex items-center justify-center min-h-screen"
                        ...
                        <div class="text-center w-full max-w-sm mx-auto px-8">
                            <!-- Logo dan Brand -->
                            <div class="mb-16">
                                ...
                                <h2 class="text-5xl font-bold text-white mb-3">QR Anggurin</h2>
                                <p class="text-white/80 text-xl">Generator & Scanner QR Code</p>
                            </div>
                            ...
                            <nav class="space-y-6 w-full">
                                <a href="{{ url('/') }}"
                                   ...
                                   @click="mobileMenuOpen = false">
                                    <div class="flex items-center justify-center space-x-4 bg-white/15 backdrop-blur-sm rounded-2xl py-6 px-8 hover:bg-white/25 transition-all duration-300 shadow-lg">
                                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                                        </svg>
                                        <span class="text-2xl font-bold">Beranda</span>
                                    </div>
                                </a>
                                ...
                                <a href="{{ route('qr.generator') }}"
                                   ...
                                   @click="mobileMenuOpen = false">
                                    <div class="flex items-center justify-center space-x-4 bg-white/15 backdrop-blur-sm rounded-2xl py-6 px-8 hover:bg-white/25 transition-all duration-300 shadow-lg">
                                        ...
                                        <span class="text-2xl font-bold">Bikin QR</span>
                                    </div>
                                </a>
                                ...
                                <a href="{{ route('qr.scanner') }}"
                                   ...
                                   @click="mobileMenuOpen = false">
                                    <div class="flex items-center justify-center space-x-4 bg-white/15 backdrop-blur-sm rounded-2xl py-6 px-8 hover:bg-white/25 transition-all duration-300 shadow-lg">
                                        ...
                                        <span class="text-2xl font-bold">Scan QR</span>
                                    </div>
                                </a>
                            </nav>
                            ...
                            <div class="mt-16 pt-8 border-t border-white/30">
                                ...
                                <p class="text-white/60 text-sm mt-2">Developed by Angga Artupas</p>
                            </div>
                        </div>
                    </div>
                </div>
